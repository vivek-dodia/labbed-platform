...
func SeedNosImages(db *gorm.DB) {
	systemImages := []nosimage.NosImage{
		...
		{
			UUID:        uuid.New().String(),
			Name:        "Network Multitool (srl-labs)",
			ClabKind:    "linux",
			DockerImage: "ghcr.io/srl-labs/network-multitool",
			DefaultUser: "root",
			DefaultPass: "",
			IsSystem:    true,
			OrgID:       0,
		...
		{
			UUID:        uuid.New().String(),
			Name:        "Network Multitool (Praqma)",
			ClabKind:    "linux",
			DockerImage: "praqma/network-multitool",
			DefaultUser: "root",
			DefaultPass: "",
			IsSystem:    true,
			OrgID:       0,
		...
		},
		{
			...
			ClabKind:    "linux",
			DockerImage: "networkstatic/iperf3:latest",
			DefaultUser: "root",
			DefaultPass: "",
			IsSystem:    true,
			OrgID:       0,
